		                ...
		                <s:iterator value="formBean.order.product_List" status = "st" id="orderProduct" >
						 	<tr id="row<s:property value="#st.index"/>"  class="excelTable">
						 		...
						 		<td><select id="priceSlect<s:property value="#st.index"/>" name="formBean.order.product_List[<s:property value="#st.index"/>].salePriceSelected" onchange="onWholeSalePriceChange(3,<s:property value="#st.index"/>);">
							           <option value='<s:property value="#orderProduct.productBarcode.product.wholeSalePrice"/>' <s:if test="#orderProduct.productBarcode.product.wholeSalePrice == #orderProduct.salePriceSelected">selected</s:if>>预设价1 <s:text name="format.price"><s:param value="#orderProduct.productBarcode.product.wholeSalePrice"/></s:text></option>
									   <option value='<s:property value="#orderProduct.productBarcode.product.wholeSalePrice2"/>' <s:if test="#orderProduct.productBarcode.product.wholeSalePrice2 == #orderProduct.salePriceSelected">selected</s:if>>预设价2 <s:text name="format.price"><s:param value="#orderProduct.productBarcode.product.wholeSalePrice2"/></s:text></option>
	                                   <option value='<s:property value="#orderProduct.productBarcode.product.wholeSalePrice3"/>' <s:if test="#orderProduct.productBarcode.product.wholeSalePrice3 == #orderProduct.salePriceSelected">selected</s:if>>预设价3 <s:text name="format.price"><s:param value="#orderProduct.productBarcode.product.wholeSalePrice3"/></s:text></option>
	                                   <option value='<s:property value="#orderProduct.productBarcode.product.salesPriceFactory"/>' <s:if test="#orderProduct.productBarcode.product.salesPriceFactory == #orderProduct.salePriceSelected">selected</s:if>>厂家价 <s:text name="format.price"><s:param value="#orderProduct.productBarcode.product.salesPriceFactory"/></s:text></option>		        
							           <option value='<s:property value="#orderProduct.productBarcode.product.salesPrice"/>' <s:if test="#orderProduct.productBarcode.product.salesPrice == #orderProduct.salePriceSelected">selected</s:if>>连锁价 <s:text name="format.price"><s:param value="#orderProduct.productBarcode.product.salesPrice"/></s:text></option>
							        </select></td>
						 		...
						 		<td><input type="text" name="formBean.order.product_List[<s:property value="#st.index"/>].wholeSalePrice" id="wholeSalePrice<s:property value="#st.index"/>" onchange='onWholeSalePriceChange(2,<s:property value="#st.index"/>);'  size='8' value="<s:text name="format.price"><s:param value="#orderProduct.wholeSalePrice"/></s:text>"   onfocus="this.select();"/></td>			 							 		
						 		<td>
