...
function exportReport(){
	...
	$.messager.confirm('确认', tips, function(r){
		if (r){
	        document.preGenReportForm.action="headqReportJSP!downloadCustAcctFlowExcelReport";
 	...
 	<div class="easyui-layout"  data-options="fit : true,border : false">
		...
		<s:form id="preGenReportForm" name="preGenReportForm" action="/action/inventoryOrder!search" theme="simple" method="POST">
		 <table width="100%" border="0">
		    ...
		    <tr class="InnerTableContent">
		      <td width="90" height="45"><strong>季度：</strong></td>
		      <td ><s:select name="formBean.year.year_ID" cssClass="easyui-combobox" data-options="editable:false"  style="width:80px;" size="1" id="year"  list="uiBean.years" listKey="year_ID" listValue="year"  />  &nbsp; &nbsp;
		           <s:select name="formBean.quarter.quarter_ID" cssClass="easyui-combobox"  style="width:80px;" data-options="editable:false" size="1" id="quarter" list="uiBean.quarters" listKey="quarter_ID" listValue="quarter_Name"  />
		      </td>
